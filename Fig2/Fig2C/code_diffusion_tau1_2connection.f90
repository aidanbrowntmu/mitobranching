...
!**************************************************************************************************************************  
        ...
        enddo                              !run loop
         ...
         sum_bond_fusion = sum_bond_fusion/real(numruns)         
         open(unit = 124,file= "rate_bond_fusion_time.dat",Access = 'append')
         open(unit = 125,file= "diffusion_time.dat",Access = 'append')
         write(124,*) t, sum_bond_fusion 
         write(125,*) t, sumx2, sumy2, sumxy 
         close(124)   
         close(125)   
  enddo   ! time loop
