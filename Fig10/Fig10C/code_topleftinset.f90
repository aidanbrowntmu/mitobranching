 ...
 !*********************read bond file***************
 open(121,file="bond_pos_L18n18.dat")
 do i= 1, bonds
...
!        print*, mi, ri,(Lxy/nodes), x, y, x_rec, y_rec, t, t_rec
        ...
        enddo                              !run loop
         ...
         open(unit = 127,file= "rate_bond_add.dat",Access = 'append')
         write(125,*) mi, t_rec, sumx2, sumy2, sumxy
         write(127,*) t_rec, sum_bond_fusion, cnt_bond, cnt_nobond
         close(125)
         close(127)
  enddo   ! time loop
