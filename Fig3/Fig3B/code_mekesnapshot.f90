        ...
        real(8) :: x, y, t, Delta_t, x_rec, y_rec, tau, xmin, ymin
 ...
 open(555,file="lattice_node_connection_info_p0.1.dat")
 !*********************read bond file***************
...
!****************************movement starts**********************************************************
          if (t .gt. 10.0*tau .and. started .eq. 0) then
            ...
            do i = 1, bonds
             if (f(i) .eq. 1) then
             write(555,*)   (((xpos(i)-xmin)+1) + 21.0*(ypos(i)- ymin)), (((xposnext(i)-xmin)+1) + 21.0*(yposnext(i)- ymin))
           !  write(555,*)   xpos(i), ypos(i), xposnext(i), yposnext(i)
             write(555,*)
        !     write(555,*)
            endif
            enddo 
